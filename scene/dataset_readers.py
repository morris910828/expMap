...
def readNerfSyntheticInfo(path, white_background, depths, eval, extension=".png"):
    ...
    val_cam_infos = readCamerasFromTransforms(path, "transforms_val.json", depths_folder, white_background, True, extension)
    ...
    if not os.path.exists(ply_path):
        ...
        print(f"Generating point cloud ({num_pts}) from mesh...")
