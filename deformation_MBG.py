...
from scene import StructuralGaussianModel, MeshBasedGaussianModel
...
def update_gaussians_MBG(gaussians : MeshBasedGaussianModel, ori_vert, deform_vert, f):
    ...
    triangles = gaussians.vertices[gaussians.face_idx].float()
...
def deformation(dataset : ModelParams, iteration : int, pipeline : PipelineParams, deform_path : str):
    with torch.no_grad():
...
if __name__ == "__main__":
    ...
    deformation(model.extract(args), args.iteration, pipeline.extract(args), args.deform_path)